				...
				<div class="panel_s"> 
					<div class="panel-body">
						...
						<div class="row">
							...
							<div  class="col-md-3 leads-filter-column">
								<div class="form-group">
									<select name="location_filter[]" id="location_filter" data-live-search="true" class="selectpicker" multiple="true" data-actions-box="true" data-width="100%" data-none-selected-text="<?php echo _l('location'); ?>">
										<?php foreach($locations as $location) { ?>
											<option value="<?php echo new_html_entity_decode($location['warehouse_id']); ?>"><?php echo new_html_entity_decode($location['warehouse_name']); ?></option>
										<?php } ?>
									</select>
								</div>
							</div> 
						...
						<?php render_datatable(array(
							...
							_l('product_qty'),
							//_l('routing_label'),
							_l('Unassigned Finished Product'),
							_l('unit_id'),
							_l('location'),
							_l('status'),
