            ...
            <div class="modal-body">
                ...
                <div class="horizontal-scrollable-tabs preview-tabs-top">
                  ...
                  <ul class="nav nav-tabs nav-tabs-horizontal mbot15" role="tablist">
                   <li role="presentation" class="active">
                    ...
                    <?php /*
                    <li role="presentation">
                       <a href="#unit_conversion" aria-controls="unit_conversion" role="tab" data-toggle="tab" aria-controls="unit_conversion">
                       <i class="fas fa-weight menu-icon"></i>&nbsp;<?php echo _l('Unit Conversion'); ?>
                       </a>
                    </li>  
                    */ ?>                  
               ...
               <div class="tab-content">
                ...
                <!-- interview process start -->
                  <div role="tabpanel" class="tab-pane active" id="interview_infor">
                        <div class="row parent_item_hide">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-3">
                              <?php
                                $options = unit_conversion_options('type');
                                $dropdown = [];

                                foreach ($options as $option) {
                                    $dropdown[] = ['name' => $option, 'value' => "1 ".ucwords($option)];
                                }

                                echo render_select(
                                    'unit_conversion_type', // name
                                    $dropdown,              // options
                                    ['name', 'value'],       // option keys
                                    'Conversion Type',      // label
                                    '',                     // selected value
                                    ['id' => 'conversion_type'], // ✅ id should go here
                                    [],                     // wrapper attrs
                                    ''                      // field class
                                );
                              ?>
                            </div>
                            <div class="col-md-1 text-center"><i style="margin-top:34px;" class="fas fa-equals"></i></div>
                            <div class="col-md-4">
                              <?php echo render_input('unit_conversion_value', 'Conversion Value', '', 'number'); ?>
                            </div>

                            <div class="col-md-4">
                              <?php
                                $options = unit_conversion_options('unit'); //['meters', 'yards', 'pieces'];
                                $dropdown = [];

                                foreach ($options as $option) {
                                    $dropdown[] = ['name' => $option, 'value' => ucwords($option)];
                                }

                                echo render_select(
                                    'conversion_unit',       // name
                                    $dropdown,               // options
                                    ['name', 'name'],        // option keys
                                    'Conversion Unit',       // label
                                    '',                      // selected
                                    ['id' => 'conversion_unit'] // ✅ Correct place to set the ID
                                );
                              ?>
                            </div>                          
                 ...
                 <?php /*
                <!-- Unit Conversion -->
                <div role="tabpanel" class="tab-pane" id="unit_conversion">
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form">
                        <div id="">
