		...
		if ($data) {
			...
			if (!isset($data['id'])) {
				...
				foreach ( $data['formdata'] as $key => $value) {
					...
					if($value['name'] == 'conversion_unit'){
						$data['conversion_unit'] = $value['value'];
					}
					
					if($value['name'] == 'unit_conversion_type'){
						$data['unit_conversion_type'] = $value['value'];
					}
					
					if($value['name'] == 'unit_conversion_value'){
						$data['unit_conversion_value'] = $value['value'];
					}					
				}
