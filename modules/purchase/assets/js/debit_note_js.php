...
$(document).ready(function () {
    // hide Admin Note row on load
    $("#adminnote").closest('.form-group').hide();
    ...
    $("#note_type").on("change", function () {
        ...
        if(val !== ""){
            // show Admin Note when something selected
            $("#adminnote").closest('.form-group').hide();
            // append value to Admin Note field
            $("#adminnote").val(val);
        } else {
            // hide again if nothing selected
            $("#adminnote").closest('.form-group').hide();
            $("#adminnote").val('');
        }
    });
