		              		...
		              		<div class="col-md-12">    
			                    ...
			                    <div class="col-md-3">
				                    ...
				                    <?php foreach($vendors as $or){ ?>
				                      <option data-content="<?php echo pur_html_entity_decode($or['company']); ?>" value="<?php echo pur_html_entity_decode($or['userid']); ?>"><?php echo pur_html_entity_decode($or['company']); ?></option>
				                    <?php } ?>
				                  	</select>
			                    </div>
			                    <div class="col-md-3">
