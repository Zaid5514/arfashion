                           ...
                           <table class="table items items-preview estimate-items-preview" data-type="estimate">
                              <thead>
                                 <tr>
                                    ...
                                    <th align="right"><?php echo _l('Value - Per Unit'); ?></th>
                                    <th align="left"><?php echo _l('Price - Per Unit'); ?></th>                                    
                                    
                                    <th align="right">Converted <?php echo _l('purchase_quantity'); ?></th>
                              ...
                              <tbody class="ui-sortable">
                                 ...
                                 <tr nobr="true" class="sortable">
                                    ...
                                    <td align="right"><?php echo pur_html_entity_decode($es['c_qty']). ' '.$es['c_type']; ?></td>                                    
                                    <td align="right"><?php echo pur_html_entity_decode($es['c_value']). ' '.ucfirst(str_replace('_',' ',$es['c_unit'])); ?></td>                                    
                                    <td align="right"><?php echo pur_html_entity_decode($es['c_unit_price']); ?></td>                                    
