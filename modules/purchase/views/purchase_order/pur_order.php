                   ...
                   <div class="col-md-6">
                      ...
                      <div class="row">
                        <div class="form-group col-md-6">
                          ...
                          <select name="vendor" id="vendor" class="selectpicker" <?php if(isset($pur_order)){ echo 'disabled'; } ?> onchange="estimate_by_vendor(this); return false;" data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>" >
                              ...
                              <option data-content="<?php echo pur_html_entity_decode($s['company']); ?>" value="<?php echo pur_html_entity_decode($s['userid']); ?>" <?php if(isset($pur_order) && $pur_order->vendor == $s['userid']){ echo 'selected'; }else{ if(isset($ven) && $ven == $s['userid']){ echo 'selected';} } ?>><?php echo pur_html_entity_decode($s['company']); ?></option>
                                <?php } ?>
                          </select>  
                      ...
                      <div class="col-md-<?php if(get_purchase_option('purchase_order_setting') == 1 ){ echo '12' ;}else{ echo '6' ;} ;?> form-group">
                        <label for="department"><?php echo _l('department'); ?></label>
                          <select name="department" id="department" class="selectpicker" <?php if(isset($pur_order)){ echo 'disabled'; } ?> data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>">
                            <option value=""></option>
                      ...
                      <label for="sale_invoice"><?php echo _l('sale_invoice'); ?></label>
                        <select name="sale_invoice" id="sale_invoice" class="selectpicker" onchange="coppy_sale_invoice(); return false;" data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>">
                          ...
                          <?php foreach($invoices as $inv) { ?>
                            <option value="<?php echo pur_html_entity_decode($inv['id']); ?>" <?php if(isset($pur_order) && $inv['id'] == $pur_order->sale_invoice){ echo 'selected'; } ?>><?php echo format_invoice_number($inv['id']); ?></option>
                            <?php } ?>
                        </select>
                      </div>
                    </div>
            ...
            <div class="table-responsive s_table ">
              <table class="table invoice-items-table items table-main-invoice-edit has-calculations no-mtop">
                <thead>
                  <tr>
                    <th></th>
                    <th width="11%" align="left"><i class="fa fa-exclamation-circle" aria-hidden="true" data-toggle="tooltip" data-title="<?php echo _l('item_description_new_lines_notice'); ?>"></i> <?php echo _l('invoice_table_item_heading'); ?></th>
                    <th width="11%" align="left"><?php echo _l('item_description'); ?></th>

                    <!-- NEW COLUMNS -->
                    <th width="7%" align="right" style="font-size: 12px;"><?php echo _l('Quantity'); ?></th>
                    <!-- <th width="8%" align="left"><?php echo _l('Type'); ?></th> -->
                    <th width="8%" align="right" style="font-size: 12px;"><?php echo _l('Value - Per Unit'); ?></th>
                    <th width="7%" align="left" style="font-size: 12px;"><?php echo _l('Price - Per Unit'); ?></th>
...
<style>
/* Hide Subtotal(after tax), Discount(%), Discount(RS) columns */
table.invoice-items-table th:nth-child(7), /* unit price main */
table.invoice-items-table td:nth-child(7),
table.invoice-items-table th:nth-child(11),
table.invoice-items-table td:nth-child(11),
table.invoice-items-table th:nth-child(12),
table.invoice-items-table td:nth-child(12),
table.invoice-items-table th:nth-child(13),
table.invoice-items-table td:nth-child(13) {
