...
$join = [
    ...
    'LEFT JOIN '.db_prefix().'warehouse ON '.db_prefix().'warehouse.warehouse_id='.db_prefix().'pur_vendor.location_id',
];
...
foreach ($rResult as $aRow) {
    ...
    if (isset($aRow['warehouse_name']) && $aRow['warehouse_name']) {
        ...
        $location = $this->ci->warehouse_model->get_location($aRow['location_id']);
        if ($location) {
