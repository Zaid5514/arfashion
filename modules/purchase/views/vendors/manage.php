               ...
               <div class="panel-body">
                <div class="row">
                  ...
                  <div class="_buttons">
                     ...
                     <a href="<?php echo admin_url('purchase/vendor'); ?>" class="btn btn-info mright5 test pull-left display-block" target="_blank">
                     ...
                     <a href="<?php echo admin_url('purchase/all_contacts'); ?>" class="btn btn-info pull-left display-block mright5" target="_blank">
                  ...
                  <?php } ?>
                    ...
                    <div class="col-md-8">
                      <div style="display:flex" class="btn-group pull-right btn-with-tooltip-group _filter_data" data-toggle="tooltip" data-title="<?php echo _l('filter_by'); ?>">
                     
                     <?php if (count($vendor_categorys) > 0) { ?>
                     <div class="mb-2">
                        <?php foreach ($vendor_categorys as $group) { 
                           $cat_id = pur_html_entity_decode($group['id']);
                           $cat_name = pur_html_entity_decode($group['category_name']);
                        ?>
                           <button type="button"
                           class="btn btn-primary vendor-category-btn"
                           data-category-id="vendor_category_<?php echo $cat_id; ?>"
                           onclick="filterVendorCategory('<?php echo $cat_id; ?>')">
                           <?php echo $cat_name; ?>
                           </button>
                        <?php } ?>
                     </div>
                     ...
                     $_table_data = array(
                      '<span class="hide"> - </span><div class="checkbox mass_select_all_wrap"><input type="checkbox" id="mass_select_all" data-to-table="vendors"><label></label></div>',
                       array(
                        ...
                        array(
                         'name'=>_l('location'),
                         'th_attrs'=>array('class'=>'toggleable', 'id'=>'th-location')
                        ),
                         array(
