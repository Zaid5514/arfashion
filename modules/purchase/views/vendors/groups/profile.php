         ...
         <div role="tabpanel" class="tab-pane<?php if(!$this->input->get('tab')){echo ' active';}; ?>" id="contact_info">
            <div class="row">
               ...
               <div class="col-md-6">
                  ...
                  <div class="form-group">
                     <label for="location_id"><?php echo _l('location'); ?></label>
                     <?php 
                     $location_id = (isset($client) ? $client->location_id : '');
                     echo render_select('location_id', $locations, array('warehouse_id', 'warehouse_name'), '', $location_id, array('data-none-selected-text' => _l('dropdown_non_selected_tex'))); 
                     ?>
                  </div>
