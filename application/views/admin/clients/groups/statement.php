...
<div class="row">
    ...
    <div class="col-md-8">
        <div class="text-right mb-3">
            <button id="btnShowGrouped" class="btn btn-secondary">Grouped Statement</button>
            <button id="btnShowOriginal" class="btn btn-secondary">Original Statement</button>
            <button id="printBtn" class="btn btn-primary btn-sm"><i class="fa fa-print"></i></button>
        </div>
    </div>    
    <div class="col-md-8 col-xs-12 hide">
    ...
    <div class="col-md-12 mtop15">
        <div class="row">
            <div class="col-md-12 format_organization_info">
            ...
            <div class="col-md-7 format_customer_info">
                <address>
