        ...
        <div class="horizontal-scrollable-tabs preview-tabs-top panel-full-width-tabs">
            ...
            <div class="horizontal-tabs">
                <ul class="nav nav-tabs nav-tabs-horizontal mbot15" role="tablist">
                    ...
                    <li role="presentation" class="active"> <!-- PO Module -->
                        <a href="#tab_tracking" onclick="get_proposal_tracking(); return false;"
                            aria-controls="tab_comments" role="tab" data-toggle="tab">
                            <?php echo _l('Tracking'); ?>
                        </a>
                    </li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane" id="tab_proposal">
                    ...
                    <div role="tabpanel" class="tab-pane active" id="tab_tracking"> <!-- PO Module -->
                        <div class="row proposal-tracking mtop15">
                            <div class="col-md-12">
                                <div id="proposal-tracking"></div>
                            </div>
                        </div>
                    </div>                    
...
// Auto-load tracking when detail view opens
get_proposal_tracking();
</script>
